...
{
    if (!me->m_spells[0])
        TC_LOG_ERROR("misc", "ArcherAI set for creature (entry = {}) with spell1=0. AI will do nothing", me->GetEntry());
...
{
    if (!me->m_spells[0])
        TC_LOG_ERROR("misc", "TurretAI set for creature (entry = {}) with spell1=0. AI will do nothing", me->GetEntry());
