...
namespace rbac
{
    ...
    RBACCommandResult RBACData::GrantPermission(uint32 permissionId, int32 realmId)
    {
    ...
    RBACCommandResult RBACData::DenyPermission(uint32 permissionId, int32 realmId)
    {
        RBACPermission const* perm = sAccountMgr->GetRBACPermission(permissionId);
        if (!perm)
        {
    ...
    RBACCommandResult RBACData::RevokePermission(uint32 permissionId, int32 realmId)
    {
