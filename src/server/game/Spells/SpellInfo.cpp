...
int32 SpellInfo::CalcPowerCost(Unit const* caster, SpellSchoolMask schoolMask, int32 powerEntryIndex) const
{
    ...
    if (AttributesEx & SPELL_ATTR1_DRAIN_ALL_POWER)
    {
        ...
        TC_LOG_ERROR("spells", "SpellInfo::CalcPowerCost: Unknown power type '{}' in spell {}", power, Id);
        return 0;
    }
    ...
    if (costPercentage)
    {
        switch (power)
        {
            ...
            case POWER_RUNIC_POWER:
                ...
                break;
            default:
                TC_LOG_ERROR("spells", "CalculateManaCost: Unknown power type '{}' in spell {}", power, Id);
                return 0;
        }
    }
