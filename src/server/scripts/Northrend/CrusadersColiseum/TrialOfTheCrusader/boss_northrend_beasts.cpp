    ...
    public:
        ...
        struct npc_snobold_vassalAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (_instance)
                    _bossGUID = _instance->GetGuidData(NPC_GORMOK);
...
struct boss_jormungarAI : public BossAI
{
    ...
    void JustDied(Unit* /*killer*/) override
    {
        if (instance)
        {
            if (Creature* otherWorm = Unit::GetCreature(*me, instance->GetGuidData(OtherWormEntry)))
            {
    ...
    public:
        ...
        struct boss_icehowlAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                _trampleTargetGUID = ObjectGuid::Empty;
                _trampleTargetX = 0;
                _trampleTargetY = 0;
                _trampleTargetZ = 0;
                _stage = 0;
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                switch (_stage)
                {
                    ...
                    case 4:
                        me->StopMoving();
                        me->AttackStop();
                        Talk(EMOTE_TRAMPLE_START, ObjectAccessor::GetUnit(*me, _trampleTargetGUID));
