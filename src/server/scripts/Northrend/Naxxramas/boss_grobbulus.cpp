...
public:
    ...
    struct boss_grobbulusAI : public BossAI
    {
        ...
        void SpellHitTarget(Unit* target, const SpellInfo* spell) override
        {
            ...
            {
                if (TempSummon* slime = me->SummonCreature(NPC_FALLOUT_SLIME, target->GetPositionX(), target->GetPositionY(), target->GetPositionZ(), 0, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 0ms))
