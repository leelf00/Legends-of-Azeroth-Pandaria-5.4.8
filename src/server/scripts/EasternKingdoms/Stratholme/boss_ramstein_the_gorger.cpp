...
public:
    ...
    struct boss_ramstein_the_gorgerAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            {
                if (Creature* mob = me->SummonCreature(NPC_MINDLESS_UNDEAD, 3969.35f+irand(-10, 10), -3391.87f+irand(-10, 10), 119.11f, 5.91f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 1800000ms))
